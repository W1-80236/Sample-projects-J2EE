...
public class UserDao {
	...
	public int save(User u) {
		String sql = "INSERT INTO users( first_name, last_name, email, mobile, birth, password) VALUES( ?, ?, ?, ?, ?, ?)";
	...
	public int updatePassword(Credentials cr,int userId) {
		String sql ="UPDATE users SET password=? WHERE id=?";
		int count = jdbcTemplate.update(sql,cr.getPasswd(),userId);
		return count;
